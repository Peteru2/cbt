      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-[1fr_320px] gap-8">
        <div>
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold">CBT Practice Test</h1>
              <p className="text-slate-400 mt-1">Candidate: {candidateId}</p>
            </div>
            <Timer />
          </div>
        ...
        <aside
          className="bg-slate-900 border border-slate-800 rounded-3xl p-6
                h-fit sticky top-6"
        >
          <h2 className="text-xl font-bold mb-6">Question Palette</h2>
          <QuestionPalette />
          <button
